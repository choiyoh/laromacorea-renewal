...
describe('Board CRUD Integration Tests', () => {
  ...
  describe('Post Reading Flow', () => {
    it('should fetch posts for specific board', async () => {
      ...
      expect(mockFirestore.where).toHaveBeenCalledWith('boardType', '==', 'free')
  ...
  describe('Comment System Integration', () => {
    ...
    it('should fetch comments for post', async () => {
      ...
      expect(mockFirestore.where).toHaveBeenCalledWith('postId', '==', 'post-id')
      expect(mockFirestore.where).toHaveBeenCalledWith('isDeleted', '==', false)
  ...
  describe('Error Handling', () => {
    it('should handle post creation errors', async () => {
      ...
      await expect(postService.createPost(postData)).rejects.toThrow('Permission denied')
    })
    ...
    it('should handle post fetch errors', async () => {
      ...
      await expect(postService.getPosts('free')).rejects.toThrow('Network error')
    })
    ...
    it('should handle comment creation errors', async () => {
      ...
      await expect(commentService.createComment(commentData)).rejects.toThrow('Validation error')
    })
  })
})
