...
describe('Boards Store', () => {
  ...
  describe('actions', () => {
    describe('fetchPosts', () => {
      it('should fetch all posts when no board type specified', async () => {
        ...
        expect(mockApiService.getDocuments).toHaveBeenCalledWith(
          ...
          expect.arrayContaining([
            expect.objectContaining({ _key: { path: { segments: ['createdAt'] } } }),
      ...
      it('should handle fetch posts error', async () => {
        ...
        expect(mockErrorStore.handleFirebaseError).toHaveBeenCalledWith(error, 'Fetch Posts - free')
      })
      ...
      it('should set loading state correctly', async () => {
        ...
        expect(mockErrorStore.setLoading).toHaveBeenCalledWith('fetch-posts-free', true)

        await fetchPromise

        expect(mockErrorStore.setLoading).toHaveBeenCalledWith('fetch-posts-free', false)
      })
    })
    ...
    describe('fetchPost', () => {
      it('should fetch single post', async () => {
        ...
        expect(mockApiService.getDocument).toHaveBeenCalledWith('posts', 'post1')
      ...
      it('should handle fetch post error', async () => {
        ...
        await expect(boardsStore.fetchPost('nonexistent')).rejects.toThrow('Post not found')
    ...
    describe('createPost', () => {
      it('should create new post', async () => {
        ...
        mockApiService.getDocuments.mockResolvedValue([...mockPosts, { id: 'new-post-id' }])
      ...
      it('should handle create post error', async () => {
        ...
        await expect(boardsStore.createPost(postData)).rejects.toThrow('Create failed')
    ...
    describe('updatePost', () => {
      ...
      it('should update existing post', async () => {
        ...
        expect(mockApiService.updateDocument).toHaveBeenCalledWith('posts', 'post1', updateData)
      ...
      it('should handle update post error', async () => {
        ...
        await expect(boardsStore.updatePost('post1', updateData)).rejects.toThrow('Update failed')
    ...
    describe('deletePost', () => {
      ...
      it('should delete existing post', async () => {
        ...
        expect(mockApiService.deleteDocument).toHaveBeenCalledWith('posts', 'post1')
      ...
      it('should handle delete post error', async () => {
        ...
        await expect(boardsStore.deletePost('post1')).rejects.toThrow('Delete failed')
  ...
  describe('error handling', () => {
    ...
    it('should handle permission errors gracefully', async () => {
      ...
      await expect(boardsStore.createPost(postData)).rejects.toThrow('Permission denied')
  ...
  describe('loading states', () => {
    ...
    it('should manage loading state for create operations', async () => {
      ...
      const createPromise = boardsStore.createPost({ title: 'New Post', boardType: 'free' })
