<template>
  <div class="comment-item" :class="{ 'reply-comment': comment.level > 0 }">
    <div class="comment-wrapper pb-2">
      <div class="d-flex align-start">
        ...
        <div class="flex-grow-1">
          <!-- Desktop 댓글 헤더 -->
          <div
            class="comment-header d-none d-md-flex align-center justify-space-between mb-1"
          >
          ...
          <!-- Mobile 댓글 헤더 -->
          <div class="comment-header d-md-none mb-1">
    ...
    <!-- 답글 목록 -->
    <div v-if="replies.length > 0" class="replies ms-4">
      <CommentItem
